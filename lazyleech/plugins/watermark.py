...
@Client.on_message(filters.command(['setwatermark@anu1bot', 'setwatermark']) & filters.chat(ALL_CHATS))
...
@Client.on_message(filters.command(['delwatermark@Anu1bot', 'delwatermark']) & filters.chat(ALL_CHATS))
